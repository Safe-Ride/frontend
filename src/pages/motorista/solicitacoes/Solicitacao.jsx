...
const Solicitacao = () => {
    ...
    function verificarContrato(contratoInicio, contratoFim) {
        if (contratoInicio >= contratoFim) {
            ...
            setErro(prevErro => ({
                ...prevErro,
                mensagem: "Data início do contrato não pode ser após o a data fim do contrato."
            }));
                    ...
                    <div className={styles["wrapper"]}>
                        <Box>
                            <div className={styles['container']}>
                                <img className={styles["foto-perfil"]} src={FotoPerfil(solicitacao.responsavel.imagem.caminho)} alt="Foto de perfil" />
                                <div>
                                    <h2 className={styles["nome"]}>{solicitacao.responsavel.nome}</h2>
                                ...
                                />
                                <div className={styles['card']}> {/* Horário */}
                                ...
                                <div className={styles['card']}> {/* Contrato */}
                                    <div className={styles['icone']}>
                                ...
                                <div className={styles['card']}> {/* Valor */}
                                    <div className={styles['icone']}>
                                        <img className={styles['icone-img']} src={icoContrato} alt="ico" />
                                    </div>
                                    <div className={styles['content']}>
                                ...
                                <div className={styles['botoes']}>
                                    <button onClick={atualizarSolicitacao} className={styles['btn-aceitar']}>Enviar</button>
                                    <button onClick={cancelarSolicitacao} className={styles['btn-recusar']}>Recusar</button>
                                </div>
                            </div>
                        </Box>
                    </div>
