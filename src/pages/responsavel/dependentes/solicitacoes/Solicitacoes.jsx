...
const Solicitacoes = () => {
  ...
  function aceitarSolicitacao() {
    api
      .patch(
        `/solicitacoes/aprovar/${solicitacao.id}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.token}`,
  ...
  function enviarSolicitacao() {
    ...
    api
      .post(`/solicitacoes`, novaSolicitacao, {
        headers: {
          Authorization: `Bearer ${sessionStorage.token}`,
          "Content-Type": "application/json",
        },
    ...
    if (status === "PENDENTE_RESPONSAVEL") {
      return (
        <>
          ...
          <CardInfo
            ...
            info={
              FormatarData(solicitacao.contratoInicio) +
              " - " +
              FormatarData(solicitacao.contratoFim)
            }
          />
          <CardInfo
            icone={icoDinheiro}
      ...
      return (
        <>
          ...
          <div className={styles["card"]}>
            ...
            <div className={styles["content"]}>
              ...
              <div className={styles["container-checkbox"]}>
                <select
                  name=""
                  className={styles["ipt-select"]}
                  id="select-endereco"
                >
                  {enderecos.map((endereco) => {
                    return (
                      <option
                        key={"endereco" + endereco.id}
                        value={endereco.id}
                      >
                        {endereco.nome}
                      </option>
              ...
              <div className={styles["container-checkbox"]} id="checkboxes">
                <div className={styles["checkbox"]}>
                  <input
                    type="checkbox"
                    value={"SEGUNDA"}
                    className={styles["chk-dia-semana"]}
                    id={styles["chk-segunda"]}
                  />
                </div>
                <div className={styles["checkbox"]}>
                  <input
            ...
            <div className={styles["content"]}>
              ...
              <div className={styles["container-checkbox"]}>
                <select
                  ...
                  id="select-periodo"
                >
                  <option key={"MANHA"} value="MANHA">
                    Manhã
                  </option>
                  <option key={"TARDE"} value="TARDE">
                    Tarde
                  </option>
                </select>
              </div>
          ...
          <div className={styles["botoes"]}>
            <button onClick={enviarSolicitacao} className={styles["btn-preto"]}>
              Enviar Socitação
            </button>
          </div>
        </>
